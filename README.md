...
This would allow Solana to [minimize the amount of MEV](https://x.com/aeyakovenko/status/1810222589991583922) extracted from users: If users can choose between multiple leaders, they can choose the most favorable offer, which leads to competition among leaders to minimize MEV in their proposed block.
